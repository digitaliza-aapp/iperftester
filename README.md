...
Puede descargar la distribución `Live` [**Iperftester_01r03.1.iso**](http://delegacionprovincial.com/iperftester/iperftester_v01_r03.1.iso) con los scripts y todas las herramientas necesarias para poder realizar tests desde un DVD, CD o Pendrive.
